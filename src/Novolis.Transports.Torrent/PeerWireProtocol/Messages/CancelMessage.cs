...
public class CancelMessage : PeerMessage
{
    ...
    {
        get { return MessageLengthLength + MessageIdLength + PayloadLength; }
    }
    ...
    /// </returns>
    public static bool TryDecode(byte[] buffer, ref int offsetFrom, int offsetTo, out CancelMessage message,
