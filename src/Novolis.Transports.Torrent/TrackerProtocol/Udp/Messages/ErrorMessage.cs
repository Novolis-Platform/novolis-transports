...
public class ErrorMessage : TrackerMessage
{
    ...
    {
        get { return ActionLength + TransactionIdLength + Encoding.ASCII.GetByteCount(this.ErrorText); }
    }
    ...
    public static bool TryDecode(byte[] buffer, int offset, out ErrorMessage message)
    {
            ...
            offset >= 0)
        {
                ...
                transactionId >= 0)
            {
                ...
                if (errorMessage.IsNotNullOrEmpty()) message = new ErrorMessage(transactionId, errorMessage);
            }
        }
    ...
    public override int Encode(byte[] buffer, int offset)
    {
        ...
        Write(buffer, ref written, this.ErrorText);
