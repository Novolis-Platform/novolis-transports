...
public class ScrapeMessage : TrackerMessage
{
    ...
    {
        get { return ConnectionIdLength + ActionLength + TransactionIdLength + this.InfoHashes.Count() * 20; }
    }
    ...
    public override int Encode(byte[] buffer, int offset)
    {
        ...
        foreach (var infoHash in this.InfoHashes) Write(buffer, ref written, infoHash.ToByteArray());
