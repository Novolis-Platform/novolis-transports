...
public class RawReader : Stream
{
    ...
    public override long Position
    {
        get
        {
            if (this.hasPeek) return this.input.Position - 1;
    ...
    {
        get { return this.strictDecoding; }
    }
    ...
    public int PeekByte()
    {
        if (!this.hasPeek) this.hasPeek = this.Read(this.peeked, 0, 1) == 1;
