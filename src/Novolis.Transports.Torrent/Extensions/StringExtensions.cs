...
public static class StringExtensions
{
    ...
    {
        return str.Substring(0, 1).ToUpper(CultureInfo.CurrentCulture) +
               (str.Length > 1 ? str.Substring(1) : string.Empty);
    }
    ...
    public static string ToSnakeCase(this string str, params char[] separators)
    {
        ...
        return string.Join("_",
            str.ToUpper(CultureInfo.InvariantCulture).Split(separators, StringSplitOptions.RemoveEmptyEntries));
    }
