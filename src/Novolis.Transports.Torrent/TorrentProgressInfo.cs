...
public class TorrentProgressInfo
{
    ...
    public TorrentProgressInfo(string torrentInfoHash, TimeSpan duration, decimal completedPercentage, long downloaded,
        decimal downloadSpeed, long uploaded, decimal uploadSpeed, int leecherCount, int seederCount)
    {
    ...
    /// </value>
    public decimal DownloadSpeed { get; private set; }
    ...
    ///     The files.
    /// </value>
    public IEnumerable<TorrentFileInfo> Files { get; private set; }
    ...
    ///     The peers.
    /// </value>
    public IEnumerable<TorrentPeerInfo> Peers { get; private set; }
    ...
    ///     The pieces.
    /// </value>
    public List<PieceStatus> Pieces { get; private set; }
    ...
    ///     The trackers.
    /// </value>
    public IEnumerable<TorrentTrackerInfo> Trackers { get; private set; }
    ...
    /// </value>
    public decimal UploadSpeed { get; private set; }
}
